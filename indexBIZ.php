...
else if($_POST['submit2'])
{
	...
	{
		$error2 .= '<p><label class="text-danger">Please Enter your name</label></p>';
	}
	else
	{
	...
	if(empty($_POST["CUemail"]))
	{
		$error2 .= '<p><label class="text-danger">Please Enter your Email</label></p>';
	}
	else
	{
		$CUemail = clean_text($_POST["CUemail"]);
		if(!filter_var($CUemail, FILTER_VALIDATE_EMAIL))
		{
			$error2 .= '<p><label class="text-danger">Invalid email format</label></p>';
		}
	}

	if(empty($_POST["CUmessage"]))
	{
		$error2 .= '<p><label class="text-danger">Please enter your message</label></p>';
	}
	else
	{
		$lastName = clean_text($_POST["CUmessage"]);
		
	}
	if($human !== 5)
	{
		$error2 .= '<p><label class="text-danger">Your anit-spam is incorrect</label></p>';
	}
	else
	{
		$human = clean_text($_POST["human"]);
	}
	...
	if($error2 == '')
	{
		...
		{
			$result='<div class="alert alert-danger">Sorry there was an error sending your message. Try again or email us at letsridewfu@gmail.com </div>';
		}
	}
...
<div class="img-plane" id="Home">
	...
	<div class="container" id="twoPanel">
		<div class="row">
			<div id="HIW" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<h1 id="HIW" class="HIW" align="center"><strong>- How It Works -</strong></h1>
				<ol>
			...
			<div id="Pricing" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<h1 id="Pricing" class="Pricing" align="center"><strong>- Pricing -</strong></h1>
	...
	<form class="form-horizontal" role="form" id="ContactUs" method="post" action="index.php">
		<div class="form-group">
			<label for="CUname" class="col-sm-2 control-label">Name</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="CUname" name="CUname" placeholder="First & Last Name" value="<?php echo htmlspecialchars($_POST['CUname']); ?>">
				<?php echo "<p class='text-danger'> $error2</p>";?>
			</div>
		</div>
		<div class="form-group">
			<label for="CUemail" class="col-sm-2 control-label">Email</label>
			<div class="col-sm-10">
				<input type="email" class="form-control" id="CUemail" name="CUemail" placeholder="example@gmail.com" value="<?php echo htmlspecialchars($_POST['email']); ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="CUmessage" class="col-sm-2 control-label">Message</label>
			<div class="col-sm-10">
				<textarea class="form-control" rows="4" name="CUmessage"><?php echo htmlspecialchars($_POST['CUmessage']);?></textarea>
				<?php echo "<p class='text-danger'>$error2</p>";?>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-10 col-sm-offset-2">
				<input id="submit2" type="submit" value="Send" class="btn btn-primary">
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-10 col-sm-offset-2">
